...
const Footer = () => {
  ...
  const contactInfo = [
    {
      ...
      link: "https://maps.app.goo.gl/kgsCRCwXdBewXSAd7",
    },
  ];
  ...
  return (
    <footer className="bg-gradient-to-b from-white to-orange-50 border-t-2 border-yellow-300">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">
              <p className="font-semibold text-gray-700 mb-1">Developer:</p>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-gray-600 hover:text-yellow-600 transition-colors duration-300 flex items-center gap-2 group"
                  >
                    <svg
            ...
            <div className="space-y-3 mb-6">
              {whatsappNumbers.map((contact, index) => (
                <a
                  ...
                  className="flex items-center gap-3 bg-orange-50 hover:bg-orange-100 border border-yellow-200 hover:border-yellow-400 rounded-lg p-3 transition-all duration-300 group"
                >
                  <div className="w-10 h-10 bg-gradient-to-br from-green-400 to-green-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
                    <svg
                  ...
                  <svg
                    className="w-5 h-5 text-yellow-600 ml-auto transform group-hover:translate-x-1 transition-transform"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="flex gap-3">
                {socialMedia.map((social, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-orange-50 hover:bg-gradient-to-br hover:from-yellow-400 hover:to-orange-500 border border-yellow-200 hover:border-yellow-400 rounded-lg flex items-center justify-center transition-all duration-300 group"
